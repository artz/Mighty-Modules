Mighty.define(["mighty.core"], function( core ){
	...
	return {			
		...
		_create: function () {
			...
			core.getCSS( core.option("mighty.basePath") + "mighty/localnews/mighty.localnews.css" );
			...
			core.delegate( element, ".change-city-button", "click", function( event ){
				...
				changeCity[0].style.display="block";
					...
					core.delegate( element, '.change-city-submit', "click", function( event ) {
						...
						core.getJSONP("../src/api/?module=mighty.localnews&count="+options.count+"&vertical="+vertical, function( data ){
