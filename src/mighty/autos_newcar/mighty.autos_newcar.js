Mighty.define(["mighty.core"], function( core ){
    ...
    core.inlineCSS(".mighty-autos_newcar {background: url(" + Mighty.option("basePath") + "mighty/autos_newcar/aol-autos_logo.jpg) no-repeat 230px bottom #fff;border:5px solid #0069b5;clear:both;min-height: 165px;overflow: hidden;padding:22px 15px;width: 300px;}\
	@font-face{font-family:'BebasNeue';src:url('http://o.aolcdn.com/os/fonts/BebasNeue-webfont.eot');src:url('http://o.aolcdn.com/os/fonts/BebasNeue-webfont.eot?iefix') format('eot'),url('http://o.aolcdn.com/os/fonts/BebasNeue-webfont.woff') format('woff'),url('http://o.aolcdn.com/os/fonts/BebasNeue-webfont.ttf') format('truetype'),url('http://o.aolcdn.com/os/fonts/BebasNeue-webfont.svg#webfontfvFLBU0N') format('svg');font-weight:normal;font-style:normal;}\
	.mighty-autos h2 {font-family:BebasNeue;font-size: 32px;margin-bottom: 15px;}\
	.mighty-autos h2 em {color:#2a65b3;}\
	.mighty-autos label {display: block;margin-left:10px;}\
    ...
    return {
		...
		_bindEvents: function () {
			...
			while ( form.childNodes[i] ){
				var that = form.childNodes[i];

				if(that.nodeName === 'H3'){
					makeSelect.appendChild(new Option(that.textContent, that.textContent));
					currentMake = that.textContent;
