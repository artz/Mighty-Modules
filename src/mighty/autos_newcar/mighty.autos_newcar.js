Mighty.define(["mighty.core"], function( core ){
    ...
    core.inlineCSS(".mighty-autos {background: url(" + Mighty.option("basePath") + "mighty/autos_newcar/aol-autos_logo.jpg) no-repeat 230px bottom #fff;border:5px solid #0069b5;clear:both;min-height: 165px;overflow: hidden;padding:22px 15px;width: 300px;}\
